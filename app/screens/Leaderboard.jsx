...
const Leaderboard = () => {
  ...
  useEffect(() => {
    if (gamemode != 'PVP') {
      ...
      let queryOption
      switch (queryOptionState) {
        case 'Win Rate':
          queryOption = 'winRate'
          break
        case 'Wins-Losses':
          queryOption = 'totalGames'
          break
        case 'Current Winstreak':
          queryOption = 'currentWinStreak'
          break
        case 'Best Winstreak':
          queryOption = 'bestWinStreak'
          break
      }
      let q = query(collection(db, 'Users'), orderBy(queryOption, 'desc'), limit(50))
